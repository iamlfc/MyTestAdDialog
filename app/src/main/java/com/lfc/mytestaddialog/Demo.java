...
//        adInfo.setActivityImg("https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3713654978,3677408252&fm=11&gp=0.jpg");
    ...
    private void initListener() {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                AdManager adManager = new AdManager(Demo.this, advList);
                adManager.setOverScreen(true)
                        .setPageTransformer(new DepthPageTransformer());
                adManager.setOnImageClickListener(new AdManager.OnImageClickListener() {
                    @Override
                    public void onImageClick(View view, AdInfo advInfo) {
//                        if (advInfo.getAdId().equals("0")) {
//
//                        }
                        Toast.makeText(Demo.this, "您点击了" + advInfo.getAdId(), Toast.LENGTH_SHORT).show();
                    }
                });
                switch (position) {
                    /**
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(result)) {
                    Toast.makeText(Demo.this, "请输入弹出动画的角度!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                adManager.setOnImageClickListener(new AdManager.OnImageClickListener() {
                    @Override
                    public void onImageClick(View view, AdInfo advInfo) {
                        Toast.makeText(Demo.this, "您点击了ViewPagerItem...", Toast.LENGTH_SHORT).show();
                    }
                });
